...
function mostraWizardSetup() {
  ...
  wizard.innerHTML = '<div style="width:100%;max-width:400px;padding:env(safe-area-inset-top,40px) 24px 40px 24px;margin:0 auto">'
    ...
    + '<div style="' + wizCard + ';border-color:rgba(239,68,68,0.15)">'
    + '<div style="text-align:center;margin-bottom:12px">'
    + '<label style="font-size:0.8em;font-weight:600;color:rgba(239,68,68,0.7);margin-bottom:6px;display:block">Chi deve saldare?</label>'
    + '<select id="wizardDebitore" style="' + wizInp + ';text-align:center;text-align-last:center;border-color:rgba(239,68,68,0.2)">'
    ...
    + '</select>'
    + '</div>'
    + '<div id="wizardDebitoImportoGroup" style="display:none;text-align:center;margin-top:12px">'
    + '<label style="font-size:0.8em;font-weight:600;color:rgba(239,68,68,0.7);margin-bottom:6px;display:block">Importo</label>'
    + '<div style="display:flex;align-items:center;justify-content:center;gap:8px;max-width:240px;margin:0 auto">'
    + '<span style="font-size:1.1em;color:rgba(239,68,68,0.7);font-weight:700">&euro;</span>'
    + '<input type="number" id="wizardDebitoImporto" value="0" min="0" step="0.01" style="' + wizInp + ';text-align:center;font-weight:700;border-color:rgba(239,68,68,0.2)">'
    + '</div>'
    + '</div>'
    + '</div>'
    ...
    + '<div id="wizardBuoniQuantita" style="display:none;' + wizCard + ';border-color:rgba(255,152,0,0.15)">'
    + '<div style="font-size:0.85em;font-weight:600;color:rgba(255,152,0,0.8);margin-bottom:10px;text-align:center">Quanti buoni hai?</div>'
    + '<div style="display:flex;align-items:center;justify-content:center;gap:10px;max-width:240px;margin:0 auto 12px auto">'
    + '<span style="font-size:1em;color:rgba(255,152,0,0.7)">N&deg;</span>'
    + '<input type="number" id="wizardNumBuoni" value="0" min="0" style="flex:1;' + wizInp + ';text-align:center;font-weight:700;border-color:rgba(255,152,0,0.2)">'
    + '</div>'
    + '<div style="font-size:0.85em;font-weight:600;color:rgba(255,152,0,0.8);margin-bottom:10px;text-align:center">Valore singolo buono</div>'
    + '<div style="display:flex;align-items:center;justify-content:center;gap:10px;max-width:240px;margin:0 auto">'
    + '<span style="font-size:1em;color:rgba(255,152,0,0.7)">&euro;</span>'
    + '<input type="number" id="wizardValoreBuono" value="10.50" min="0" step="0.01" style="flex:1;' + wizInp + ';text-align:center;font-weight:700;border-color:rgba(255,152,0,0.2)">'
    + '</div>'
    + '</div>'
    ...
    + '<select id="wizardIconaConto" style="' + wizInp + '">'
