...
function aggiornaListaObiettiviInvestimento() {
  ...
  DB.obiettivi.forEach(function(obj, index) {
    ...
    html += '<div style="padding:12px 6px;background:#27ae60;border-radius:10px;text-align:center">';
    ...
    html += '<div style="padding:12px 6px;background:#2196f3;border-radius:10px;text-align:center">';
    ...
    html += '<div style="padding:12px 6px;background:#ff9800;border-radius:10px;text-align:center">';
