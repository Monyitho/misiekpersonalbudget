...
function aggiornaListaObiettiviInvestimento() {
  ...
  DB.obiettivi.forEach(function(obj, index) {
    ...
    // Griglia stats 3 colonne - align-items:stretch per altezze uguali
    html += '<div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:8px;margin-bottom:14px;align-items:stretch">';

    html += '<div style="padding:12px 6px;background:#27ae60;border-radius:10px;text-align:center;display:flex;flex-direction:column;justify-content:center">';
    html += '<div style="font-size:0.65em;color:rgba(255,255,255,0.85);font-weight:700;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:4px">💵 Risparmiato</div>';
    html += '<div style="font-size:1em;font-weight:800;color:#fff">' + formatEuro(risparmiato) + '</div>';
    html += '</div>';

    html += '<div style="padding:12px 6px;background:#2196f3;border-radius:10px;text-align:center;display:flex;flex-direction:column;justify-content:center">';
    html += '<div style="font-size:0.65em;color:rgba(255,255,255,0.85);font-weight:700;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:4px">🎯 Obiettivo</div>';
    html += '<div style="font-size:1em;font-weight:800;color:#fff">' + formatEuro(obj.target) + '</div>';
    html += '</div>';

    html += '<div style="padding:12px 6px;background:#ff9800;border-radius:10px;text-align:center;display:flex;flex-direction:column;justify-content:center">';
    html += '<div style="font-size:0.65em;color:rgba(255,255,255,0.85);font-weight:700;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:4px">💰 Mancante</div>';
    html += '<div style="font-size:1em;font-weight:800;color:#fff">' + formatEuro(mancante) + '</div>';
    html += '</div>';
    ...
    if (obj.dataFine && !isScaduto && mancante > 0) {
      ...
      html += '<div style="padding:10px;background:#9c27b0;border-radius:10px;text-align:center">';
      html += '<div style="font-size:0.65em;color:rgba(255,255,255,0.85);font-weight:700;margin-bottom:4px">⏱️ Giorni Rimasti</div>';
      html += '<div style="font-size:1.05em;font-weight:800;color:#fff">' + giorniRimasti + '</div>';
      html += '</div>';

      if (risparmioMensileNecessario > 0) {
        html += '<div style="padding:10px;background:#00838f;border-radius:10px;text-align:center">';
        html += '<div style="font-size:0.65em;color:rgba(255,255,255,0.85);font-weight:700;margin-bottom:4px">📆 Al Mese</div>';
        html += '<div style="font-size:1.05em;font-weight:800;color:#fff">' + formatEuro(risparmioMensileNecessario) + '</div>';
        html += '</div>';
      }
